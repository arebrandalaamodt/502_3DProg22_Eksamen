...
//    Player = new OctahedronBall(2);

    {
//    mTriangle = new Triangle();

//    mOctahedronBall = new VisualObject("Ball", MeshGenerator::Octahedron(3));

////    mOctahedronBall->setMatrix(&mMatrixUniform0);
////    mOctahedronBall->setShader(mShaderProgram[0]);


//    mObjects.push_back(mOctahedronBall);


//    mObjects.push_back(new TriangleSurface());
//    mObjects.push_back(new TriangleSurface("ob1.txt"));


//      Player = new OctahedronBall(2);
//      mObjects.push_back(Player);

//    Player = new InteractiveObject("Player", MeshGenerator::Octahedron(5));
//    mObjects.push_back(Player);

//    Ground = new InteractiveObject("Ground", MeshGenerator::Create3DGraph());
//    mObjects.push_back(Ground);

//    mDisc = new Disc;
//    mObjects.push_back(mDisc);

//    mGraph = new Graph;
//    mObjects.push_back(mGraph);

//    mCube = new Cube(-1.5f, 2.1f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(-1.1f, 1.9f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(-0.6f, 0.4f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(0.3f, 0.3f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(0.4f, 0.5f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(1.2f, 1.8f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(1.5f, 2.1f, 0);
//    mObjects.push_back(mCube);

//    mCube = new Cube(1.f, 1.f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(3/2.f, 3.f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(7/2.f, 2.f, 0);
//    mObjects.push_back(mCube);
//    mCube = new Cube(26/5.f, 7/2.f, 0);
//    mObjects.push_back(mCube);
